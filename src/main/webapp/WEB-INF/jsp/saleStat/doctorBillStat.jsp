    ...
    <div class="pagemain">
        ...
        <div>
            ...
            <form action="${pageContext.request.contextPath}/doctorBillStat/query.do" METHOD="post">
                ...
                &nbsp;&nbsp;&nbsp;<input type="text" class="input_text_style" name="doctorName" />
        ...
        <table class="sui-table table-bordered" style="margin-top:20px;">
            ...
            <tr>
                ...
                <th class="center left-con" width="10%">医生名称</th>
                <th class="center left-con" width="10%">年份</th>
                <th class="center left-con" width="10%">月份</th>
                <th class="center left-con" width="15%">套餐开单量（个）</th>
                <th class="center left-con" width="15%">开单总额（元）</th>
            ...
            <c:forEach items="${list}" var="item">
                <tr>
                    ...
                    <td class="center left-con">${item.billAmount}</td>
