    ...
    <div class="pagemain">
        ...
        <div>
            ...
            <form action="${pageContext.request.contextPath}/trade/query.do" METHOD="post">
                ...
                &nbsp;&nbsp;&nbsp;<input type="text" class="input_text_style_new" name="userName" />

                &nbsp;&nbsp;&nbsp;<label class="label_Style">申请人</label>
                &nbsp;&nbsp;&nbsp;<input type="text" class="input_text_style_new" name="applyName" />

                &nbsp;&nbsp;&nbsp;<label class="label_Style">订单编号</label>
                &nbsp;&nbsp;&nbsp;<input type="text" class="input_text_style_new" name="tradeNum" />

                &nbsp;&nbsp;&nbsp;<label class="label_Style">订单状态</label>
                &nbsp;&nbsp;&nbsp;<select class="select_style" style="width: 100px" name="status">
                                    <option value=""></option>
...
<div id="edit_trade" style="display: none">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" id="hospitalIdName_edit" name="hospitalName" required lay-verify="required" class="layui-input" style="width: 260px">
        </div>
    </div>
    <%--付款方式--%>
    <div class="layui-form-item">
